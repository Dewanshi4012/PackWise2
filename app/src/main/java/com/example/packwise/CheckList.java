...
import com.example.packwise.Adapter.CheckListAdapter;
import com.example.packwise.Constants.MyConstants;
import com.example.packwise.Data.AppData;
...
public class CheckList extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        if(R.id.btnMySelections == itemID){
        ...
        else if(R.id.btnCustomList == itemID) {
        ...
        else if(R.id.btnDeleteDefault == itemID){
            new AlertDialog.Builder(this).setTitle("Delete default data").setMessage("Are you sure?" +
                    "\n\n As this " + "will delete the data provided by Packwise while installing.").setPositiveButton("Confirm", new DialogInterface.OnClickListener() {
                @Override
            ...
            }).setIcon(R.drawable.ic_warn).show();
            return true;
        }

        else if (R.id.btnReset == itemID) {
            new AlertDialog.Builder(this).setTitle("Reset to default")
                    .setMessage("Are you sure?\n\nAs this will load the default data provided by Packwise " +
        ...
        else if(R.id.btnAboutUs == itemID){
            intent = new Intent(this, AboutUs.class);
            startActivity(intent);
            return true;
        }

        else if(R.id.btnExit == itemID){
            this.finishAffinity();
        ...
        btnAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(itemName != null && !itemName.isEmpty()){
                    ...
                    Toast.makeText(CheckList.this, "Emtpy cant be added.", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
